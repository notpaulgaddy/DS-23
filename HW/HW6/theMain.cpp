...
// void gridFill(vector<string> &grid, char letter, int height,
//               int width) {
//   // fill in holes
...
// void gridMake(vector<string> &solution, int height,
...
// void gridFlip(vector<string> source,vector<string>& grid,int height, int width)
// {
//   std::copy(source.begin(),source.end(),grid.begin());
//   std::reverse(grid.begin(),grid.end());
// }

// void gridRotate(vector<string> source, vector<string>& grid,int height, int width)
// {
...
// {
//   for(vector<vector<string>>::iterator current = grids.begin() ; current != grids.end();current++)
//   {
//     int matchCount = 0;
...
// void gridMakeFillFlipRotate(vector<vector<string>> &grids,int height, int width, vector<string> plusWord, vector<string> minusWord, string answer,vector<string> grid,char letter)
// {
...
//         if(tempGrid.size()  != 0 && gridCheck(tempGrid,height,width,minusWord.begin(),minusWord.end()) && gridNotExist(grids,tempGrid))
//         {
...
//         if(tempGrid2.size()  != 0 && gridCheck(tempGrid2,height,width,minusWord.begin(),minusWord.end()) && gridNotExist(grids,tempGrid2))
//         {
...
// void gridMakeFlipRotate(vector<vector<string>> &grids,int height,int width,vector<string> plusWord,vector<string>minusWord,string answer)
// {
//   vector<string> grid;
...
//     {
//       for (char lwalpCh = 'a'; lwalpCh <= 'z'; lwalpCh++) {//loop through each letter for fill
        
//         gridMakeFillFlipRotate(grids,height,width,plusWord,minusWord,answer,grid,lwalpCh);//fill empty spots with letter
        
//       }
//     }
//     else
//     {
//       gridMakeFillFlipRotate(grids,height,width,plusWord,minusWord,answer,grid,'a'); // no fill needed so just pass 'a'
//     }
//   }
// }
// void gridMirror(vector<vector<string>> & grids,vector<string> grid,int height,int width,vector<string> minusWord)
// {
//   vector<string> tempGrid;
//         for (int i = 0; i < height; i++) {
//           string line = "";
...
//           tempGrid.push_back(line);
//         }
//         if( gridCheck(tempGrid,height,width,minusWord.begin(),minusWord.end()) && gridNotExist(grids,tempGrid))
//         {
//           grids.push_back(tempGrid);
//         }
// }
...
//   std::ifstream inputfile("C:\\Users\\twind\\Downloads\\HW6\\HW6\\puzzle1.txt");//argv[1]);  // input file name
//   std::ofstream outputfile("C:\\Users\\twind\\Downloads\\HW6\\HW6\\puzzle3out.txt"); // output file nam,e
//   string answer = "all_solutions";//argv[3];           // either one solution or all solutions
...
//   std::rotate(plusWord.rbegin(), plusWord.rbegin() +1, plusWord.rbegin() + 2);
//  int t = 0;
// }
...
// if(width == height)
// {
//   for(vector<vector<string>>::iterator it = grids.begin();it != grids.end();it++)
//   {
...
//     for (std::vector<std::string>::iterator grid = firstGrid.begin(); grid != firstGrid.end(); grid++) {
